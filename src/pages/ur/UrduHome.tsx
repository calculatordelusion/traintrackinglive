  ...
  return (
    <div>
      <SEOHead
        ...
        lang="ur"
        alternateEnglish="/"
        keywords="ٹرین ٹریکنگ پاکستان, پاکستان ریلوے لائیو ٹریکنگ, ٹرین کی لائیو لوکیشن, ریئل ٹائم ٹرین اسٹیٹس, ٹریک مائی ٹرین, پاکستان ریلوے آج کی اسٹیٹس, ٹرین ٹریکر پاکستان"
