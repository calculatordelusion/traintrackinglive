...
export default function UrduHomePage() {
  ...
  return (
    <div>
      <SEOHead
        title="ٹریک مائی ٹرین — لائیو ٹرین ٹریکنگ پاکستان 2026"
        ...
        lang="ur"
        alternateEnglish="/"
        keywords="ٹرین ٹریکنگ, ٹریک مائی ٹرین, لائیو ٹرین اسٹیٹس, ٹرین کہاں ہے, پاکستان ریلوے لائیو, ریئل ٹائم ٹرین, ٹرین ٹریکر, ٹرین لوکیشن, ٹرین کی حالت چیک, پاکستان ریلوے آج, ٹرین رنگ اسٹیٹس"
